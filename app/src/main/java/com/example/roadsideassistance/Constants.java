...
public class Constants {
    ...
    public static final String URL_VERIFY = ROOT_URL+"ValidateUser/fetch_Result.php";
    public static final String URL_UPLOAD_DOCUMENTS = ROOT_URL+"Documents/Upload_Documents.php";
    public static final String URL_FETCH_DOCUMENTS = ROOT_URL+"Documents/Fetch_Documents.php";
    public static final String URL_FETCH_DOCUMENTS_MECHANIC = ROOT_URL+"Documents/Fetch_DocumentsMechanic.php";
    public static final String URL_SAVE_VEHICLE = ROOT_URL+"Documents/save_Vehicle.php";
    public static final String URL_FETCH_VEHICLE = ROOT_URL+"Documents/fetch_Vehicle.php";
